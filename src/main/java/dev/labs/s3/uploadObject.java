...
public class uploadObject {
    ...
    private static void putS3Object(S3Client s3, String bucketName, String objectKey, String filePath) {
        try {
            ...
            metadata.put("dateime", LocalDateTime.now().toString());


            PutObjectRequest putObject = PutObjectRequest.builder().metadata(metadata).bucket(bucketName).key(objectKey).build();
